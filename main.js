...
function enableCam(event) {
  ...
  if (webcamRunning === true) {
    ...
    loadingOverlay.style.display = "flex"; // show when starting
    loadingOverlay.innerText = "Click Enable Webcam to start the stream.";
    ...
    loadingOverlay.style.display = "flex"; // show when starting
    loadingOverlay.innerText = "Loading webcam & model...";
    webcamRunning = true;
    ...
    navigator.mediaDevices.getUserMedia(constraints).then((stream) => {
      ...
      video.onloadeddata = () => {
        loadingOverlay.style.display = "none"; // hide when ready
        // checkDevices();
        predictWebcam();
      };
    });
